#include "OpenGLWidget0.h"

#define VERTEXIN 0
#define TEXTUREIN 1

OpenGLWidget0::OpenGLWidget0(QWidget *parent) : QOpenGLWidget(parent)
{
    textureY=NULL;
    textureU=NULL;
    textureV=NULL;
...
void OpenGLWidget0::slotShowYuv(uchar *ptr, uint width, uint height)
{
    if(ptr!=NULL){
...
void OpenGLWidget0::initializeGL()
{
    //调用内容初始化函数
...
void OpenGLWidget0::resizeGL(int w, int h)
{
